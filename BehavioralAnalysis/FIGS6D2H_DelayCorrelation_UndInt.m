        ...
        if ~ismember(ii,gh.param.ExcludedSession)
            ...
            for jj=1:length(stimsimu_n)
                ...
                newentry = [gh.data.simuMtx(stimsimu_n(jj),9)-gh.data.simuMtx(stimsimu_n(jj),2) , ...
                    ...
                    (gh.data.simuMtx(stimsimu_n(jj),13)./((length(pks_X0)+length(pks_X0_inv))./2))];
                if group(ii)==1
...
R_mtx =[];drawlinewidth = 2;

for ii=1:5

    figure(ii)
    if ii<=3
        scatter(datapair_sp(:,ii),max(min(datapair_sp(:,6),0.048),0.028),30,'square','MarkerFaceColor',[0.5 0.5 0.5],'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(datapair_ap(:,ii),max(min(datapair_ap(:,6),0.048),0.028),30,'diamond','MarkerFaceColor',[119 136 172]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(datapair_av(:,ii),max(min(datapair_av(:,6),0.048),0.028),30,'MarkerFaceColor',[238 129 114]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
    elseif ii==4
        scatter(min(datapair_sp(:,ii)+(rand(length(datapair_sp(:,ii)),1)-0.5)*0.05,0.625),max(min(datapair_sp(:,6),0.048),0.028),30,'square','MarkerFaceColor',[0.5 0.5 0.5],'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(min(datapair_ap(:,ii)+(rand(length(datapair_ap(:,ii)),1)-0.5)*0.05,0.625),max(min(datapair_ap(:,6),0.048),0.028),30,'diamond','MarkerFaceColor',[119 136 172]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(min(datapair_av(:,ii)+(rand(length(datapair_av(:,ii)),1)-0.5)*0.05,0.625),max(min(datapair_av(:,6),0.048),0.028),30,'MarkerFaceColor',[238 129 114]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
    elseif ii==5
        scatter(max(min(datapair_sp(:,ii),0.3),0.1),max(min(datapair_sp(:,6),0.048),0.028),30,'square','MarkerFaceColor',[0.5 0.5 0.5],'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(max(min(datapair_ap(:,ii),0.3),0.1),max(min(datapair_ap(:,6),0.048),0.028),30,'diamond','MarkerFaceColor',[119 136 172]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
        scatter(max(min(datapair_av(:,ii),0.3),0.1),max(min(datapair_av(:,6),0.048),0.028),30,'MarkerFaceColor',[238 129 114]./255,'MarkerEdgeColor','none','MarkerFaceAlpha',0.4); hold on
    end
    ...
    if P(1,2)<0.05
        ...
        [ p, yhat, ci] = polypredci(datapair_sp(:,ii),datapair_sp(:,6), 1, 0.95, xrange{ii});
        pgonci = polyshape([xrange{ii},fliplr(xrange{ii})],[yhat+ci',fliplr(yhat-ci')]);
        pgci= plot(pgonci);
        pgci.FaceAlpha = .075;
        pgci.EdgeColor = 'none';
        pgci.FaceColor = blankColor;
    else
        plot(xrange{ii},y,'linewidth',drawlinewidth,'linestyle','--','color',blankColor); hold on
    end
    clear R P p y
    ...
    if P(1,2)<0.05
        ...
        pgci.FaceAlpha = .075;
        pgci.EdgeColor = 'none';
        pgci.FaceColor = [238 129 114]./255;
    ...
    ylim([0.028 0.048]); yticks([0.028:0.004:0.048]);   xlim(xrange{ii});
